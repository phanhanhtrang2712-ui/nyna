...
const CatalogSection = ({ onAddToCart }: { onAddToCart: (product: any) => void }) => {
             ...
             <div key={cat.id} className="bg-white rounded-[48px] border border-gray-100 shadow-sm p-8 group transition-all hover:shadow-2xl hover:-translate-y-3 cursor-pointer">
                ...
                <div className="mt-8 pt-8 border-t border-gray-50 flex items-center justify-between">
                   ...
                   <button 
                    ...
                    className="bg-blue-900 text-white p-3 rounded-2xl hover:bg-pink-500 transition-all flex items-center gap-2 hover:px-5 group/btn"
                   >
                      <ShoppingCart size={18} />
                      <span className="hidden group-hover/btn:inline text-[10px] font-black uppercase tracking-widest">Thêm giỏ hàng</span>
                   </button>
                </div>
             </div>
    ...
    <section className="py-32 bg-white" id="tin tức">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          {news.map(item => (
            <div key={item.id} onClick={() => setActiveNews(item)} className="group cursor-pointer">
                ...
                {showPayment ? (
                  ...
                  >
                    ...
                    <div className="aspect-square w-48 mx-auto bg-gray-100 rounded-2xl flex items-center justify-center relative overflow-hidden">
                       {/* QR Code placeholder - in real app would be dynamic bank QR */}
                       <img 
